...
$CONF['setup_password'] = sha1(time());

// Postfix Admin Path
// Set the location of your Postfix Admin installation here.
// YOU MUST ENTER THE COMPLETE URL e.g. http://domain.tld/postfixadmin
$CONF['postfix_admin_url'] = 'https://admin.piratenpartei.ch/postfixadmin/';
...
$CONF['database_user'] = $_ENV['MYSQL_USER'];
...
$CONF['admin_email'] = 'postmaster@piratenpartei.ch';
...
$CONF['default_aliases'] = array (
    'abuse' => 'abuse@piratenpartei.ch',
    'hostmaster' => 'hostmaster@piratenpartei.ch',
    'postmaster' => 'postmaster@piratenpartei.ch',
    'webmaster' => 'webmaster@piratenpartei.ch',
    'info' => 'otrs@piratenpartei.ch'
);
...
$CONF['vacation_domain'] = 'autoreply.piratenpartei.ch';
...
$CONF['user_footer_link'] = "https://admin.piratenpartei.ch/";

// Footer
// Below information will be on all pages.
// If you don't want the footer information to appear set this to 'NO'.
$CONF['show_footer_text'] = 'YES';
$CONF['footer_text'] = 'Return to admin.piratenpartei.ch';
$CONF['footer_link'] = 'https://admin.piratenpartei.ch/';
